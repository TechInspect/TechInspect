...
class Park(models.Model):
    ...
    year = models.IntegerField(max_length=4, null=True, blank=True, verbose_name='Год производства автомобиля')
    mileage = models.IntegerField(max_length=4, null=True, blank=True, verbose_name='Пробег автомобиля')
...
class UserUID(models.Model):
    user_uid = models.IntegerField(max_length=20, db_index=True, verbose_name='Пользователь')
